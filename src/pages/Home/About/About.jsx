    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row">
        <div className="relative w-1/2">
          ...
          <img src={parts} className="lg:w-1/2 border-8 border-white absolute top-1/2 left-1/2 rounded-lg shadow-2xl" />
        </div>
        <div className="w-1/2 p-5">
            <h3 className="text-3xl font-bold text-[#FF512E]">About Us</h3>
